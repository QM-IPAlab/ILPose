...
class PoseDataset(data.Dataset):
    def __init__(self, mode, num_pt, add_noise, root, noise_trans, refine):
        if mode == 'train':
            self.path = '/homes/lt006/code/6D_without_forgetting/datasets/ycb/dataset_config/train_data_list.txt'
            # self.path = '/homes/lt006/code/6D_without_forgetting/datasets/ycb/data_list/train_1.txt'
        elif mode == 'test':
            self.path = '/homes/lt006/code/6D_without_forgetting/datasets/ycb/dataset_config/test_data_list.txt'
        self.num_pt = num_pt
        self.root = root
        ...
        class_file = open('/homes/lt006/code/6D_without_forgetting/datasets/ycb/dataset_config/classes.txt')
        class_id = 1
        self.cld = {}
        while 1:
    ...
    def __getitem__(self, index):
        ...
        if self.add_noise:
            for k in range(5):
                ...
                front = np.array(self.trancolor(Image.open('{0}/{1}-color.jpg'.format(self.root, seed)).convert("RGB")))
        ...
        if self.list[index][:8] == 'data_syn':
            ...
            back = np.array(self.trancolor(Image.open('{0}/{1}-color.jpg'.format(self.root, seed)).convert("RGB")))
